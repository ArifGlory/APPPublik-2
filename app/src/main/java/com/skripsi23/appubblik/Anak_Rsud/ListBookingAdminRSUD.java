...
public class ListBookingAdminRSUD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_booking_admin_rsud);
        ...
        adapter = new AdapterBookingRsud(ListBookingAdminRSUD.this,bookingList);
        ...
        ref.child("booking_rsud").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    new SweetAlertDialog(ListBookingAdminRSUD.this, SweetAlertDialog.WARNING_TYPE)
